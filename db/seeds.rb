...
history1 = History.create!(user: user1, goal: goal3, start_date: 1.day.ago)
history2 = History.create!(user: user2, goal: goal3, start_date: 1.day.ago)
history3 = History.create!(user: user3, goal: goal3, start_date: 1.day.ago)
history4 = History.create!(user: sam, goal: goal3, start_date: 1.day.ago)
history5 = History.create!(user: marc, goal: goal3, start_date: 1.day.ago)
