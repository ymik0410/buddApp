...
# santa = User.create(first_name: "Santa", username: "Santana", last_name: "Cadusch", email: "santa@fanta.com", password: "123456", introduction: "I am very happy to be part od BuddApp! :)", goal_description: "I finally want to commit and reach my goal and feel great in my body.", country: "Switzerland", photo: "https://kitt.lewagon.com/placeholder/users/casantadu", streak: 2, longest_streak: 10, last_activity: Time.now.to_date + 3 )
