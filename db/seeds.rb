...
user4 = User.create!(date_of_birth: 19801011, language: "English", streak: 0, longest_streak: 00, created_at: Faker::Date.between(from: 200.days.ago, to: 60.days.ago), first_name: "Fiona", last_name: "Watkins", username: "Wildlife", email: "wl@gmail.com", password: "123456", country: "ZA", introduction: "I work as a kinder garten teacher and run marathons", goal_description: "I really want to change my habits and become the best version of myself", photo: "https://vuesax.com/avatars/avatar-4.png" )
user5 = User.create!(date_of_birth: 19951011, language: "English", streak: 0, longest_streak: 0, created_at: Faker::Date.between(from: 200.days.ago, to: 60.days.ago), first_name: "Belinda", last_name: "Lopez", username: "BGarcia", email: "bg@gmail.com", password: "123456", country: "NO", introduction: "Love travelling, learning new languages and meeting new people.", goal_description: "It would be wonderful to stick to healhty eating habits consistently and tach healthy eating to my children from a young age.", photo: "https://qph.fs.quoracdn.net/main-qimg-7fb93146f5e4e470f5a590d2fc38be3b" )
# puts "users created"
